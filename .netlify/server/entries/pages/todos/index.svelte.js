...
var import_index_ee9fdf1a = require("../../../chunks/index-ee9fdf1a.js");
...
const Todos = (0, import_index_ee9fdf1a.c)(($$result, $$props, $$bindings, slots) => {
  let { todos } = $$props;
...
<div class="${"todos svelte-16nsat"}"><h1>Todos</h1>
	...
	${(0, import_index_ee9fdf1a.h)(todos, (todo) => {
    return `<div class="${["todo svelte-16nsat", todo.done ? "done" : ""].join(" ").trim()}"><form action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_ee9fdf1a.b)("value", todo.uid, 0)} class="${"svelte-16nsat"}">
				<input type="${"hidden"}" name="${"done"}"${(0, import_index_ee9fdf1a.b)("value", todo.done ? "" : "true", 0)} class="${"svelte-16nsat"}">
				<button class="${"toggle svelte-16nsat"}" aria-label="${"Mark todo as " + (0, import_index_ee9fdf1a.e)(todo.done ? "not done" : "done")}"></button></form>

			<form class="${"text svelte-16nsat"}" action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_ee9fdf1a.b)("value", todo.uid, 0)} class="${"svelte-16nsat"}">
				<input aria-label="${"Edit todo"}" type="${"text"}" name="${"text"}"${(0, import_index_ee9fdf1a.b)("value", todo.text, 0)} class="${"svelte-16nsat"}">
				<button class="${"save svelte-16nsat"}" aria-label="${"Save todo"}"></button></form>

			<form action="${"/todos?_method=DELETE"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_ee9fdf1a.b)("value", todo.uid, 0)} class="${"svelte-16nsat"}">
