...
const Counter = (0, import_index_ee9fdf1a.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"counter svelte-sx9eo4"}"><button aria-label="${"Decrease the counter by one"}" class="${"svelte-sx9eo4"}"><svg aria-hidden="${"true"}" viewBox="${"0 0 1 1"}" class="${"svelte-sx9eo4"}"><path d="${"M0,0.5 L1,0.5"}" class="${"svelte-sx9eo4"}"></path></svg></button>
	...
	<div class="${"counter-viewport svelte-sx9eo4"}"><div class="${"counter-digits svelte-sx9eo4"}" style="${"transform: translate(0, " + (0, import_index_ee9fdf1a.e)(100 * offset) + "%)"}"><strong class="${"hidden svelte-sx9eo4"}" aria-hidden="${"true"}">${(0, import_index_ee9fdf1a.e)(Math.floor($displayed_count + 1))}</strong>
			<strong class="${"svelte-sx9eo4"}">${(0, import_index_ee9fdf1a.e)(Math.floor($displayed_count))}</strong></div></div>
...
<section class="${"svelte-mjk9ig"}"><h1 class="${"svelte-mjk9ig"}"><div class="${"welcome svelte-mjk9ig"}"><picture><source srcset="${"svelte-welcome.webp"}" type="${"image/webp"}">
	...
	${(0, import_index_ee9fdf1a.v)(Counter, "Counter").$$render($$result, {}, {}, {})}
</section>`;
});
